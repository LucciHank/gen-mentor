...
**Language Directive**:
* **Vietnamese**: You MUST provide all user-facing content (titles, summaries, overviews, markdown content, and quiz text) in Vietnamese. The structure and technical instructions remain in English, but the content itself must be Vietnamese.
